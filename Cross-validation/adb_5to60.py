...
with open('blmpred5to60.npy', 'rb') as f: # Input 1 - .npy file with epitope + non-epitope embeddings of BLMPred_5to60 dataset
    features = np.load(f)
...
model = AdaBoostClassifier() # Initialize model
